...
FEATURES = ["community_health_centers", "cultural_organizations", "licensed_businesses", "restaurants", "senior_centers", "start_up_jobs", "volunteer_opportunities", "youth_programs"]
